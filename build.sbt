...
name := "linda-imam"
organization := "oh.moon"
version := "1.0"

Compile / scalaSource := baseDirectory.value / "server"
...
// libraryDependencies += "za.co.absa.cobrix" %% "spark-cobol_2.12" % "2.4.10"

// https://mvnrepository.com/artifact/za.co.absa.cobrix/spark-cobol
libraryDependencies += "za.co.absa.cobrix" %% "spark-cobol" % "2.4.10"
